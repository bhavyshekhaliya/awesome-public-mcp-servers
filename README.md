...
| Worklittle Jobs | [Official source repository](https://github.com/worklittle/jobs-mcp) (`https://mcp.worklittle.com/`, Streamable HTTP) | Search over 4 million jobs with visa, salary, and distance filters, swipe to apply in your AI app, and save roles to a Worklittle account | Worklittle account OAuth | `jobs` `search` `remote` |
